 ...
 * @author WILLIAM
 */
public class HomePublicationController implements Initializable {
    ...
    private JFXListView<Photo> listPub;
               ...
               @FXML
    private AnchorPane pubfromhome;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        listPubcopy = listPub;
         ...
         try {
            ...
            pubfromhome.getChildren().add(pubpane);
        ...
        listPub.setItems(PhS.DisplayAll());
